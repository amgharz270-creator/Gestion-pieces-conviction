...
@section('title', 'Nouveau Rôle - TPI Sidi Bennour')
...
<style>
    ...
    .checkbox-group { display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; margin-top: 10px; }
    ...
    <main class="main-content">
        ...
        <div class="page-header">
            <div>
                ...
                <h1><i class="bi bi-plus-lg" style="color: var(--accent-gold);"></i> Nouveau Rôle</h1>
            </div>
        </div>
        ...
        <div class="form-card">
            <form action="{{ route('roles.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="Ex: superviseur" required>
                </div>
                ...
                <div style="display: flex; gap: 15px; margin-top: 30px;">
                    <button type="submit" class="btn-gold"><i class="bi bi-save"></i> Créer</button>
