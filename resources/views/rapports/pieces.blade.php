...
@section('title', 'Rapport des Pièces - TPI Sidi Bennour')
    ...
    <main class="main-content">
        ...
        <div class="page-header">
            <div>
                ...
                <h1><i class="bi bi-box-seam" style="color: var(--accent-gold);"></i> Rapport des Pièces</h1>
            </div>
            <div>
                <button onclick="window.print()" class="btn-outline"><i class="bi bi-printer"></i> Imprimer</button>
            </div>
        </div>

        <!-- Filtres -->
        <div class="filter-card">
            <form method="GET" action="{{ route('rapports.pieces') }}" class="row g-3">
                <div class="col-md-3">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="7" style="text-align: center; padding: 50px;">
                            ...
                            <div>Aucune pièce trouvée</div>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
            <div class="pagination">{{ $pieces->appends(request()->query())->links() }}</div>
        </div>
    </main>
</div>
@endsection