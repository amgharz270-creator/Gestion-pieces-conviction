...
@section('title', 'Modifier mon profil - TPI Sidi Bennour')
...
<style>
    ...
    .form-card { background: var(--card-bg); border: 1px solid var(--card-border); border-radius: 20px; padding: 40px; max-width: 700px; margin: 0 auto; }
    .form-control-dark {
    ...
    <aside class="admin-sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <div class="menu-section">
                ...
                <a href="{{ route('users.profile') }}" class="menu-item active"><i class="bi bi-person-circle"></i><span>Mon Profil</span></a>
            </div>
        </nav>
    </aside>
    ...
    <main class="main-content">
        <div class="top-bar">
            <div class="breadcrumb-custom">
                ...
                <a href="{{ route('users.profile') }}">Mon Profil</a>
                <i class="bi bi-chevron-right"></i>
                <span>Modifier</span>
            </div>
        ...
        <div class="page-header">
            <div>
                <a href="{{ route('users.profile') }}"><i class="bi bi-arrow-left"></i> Retour à mon profil</a>
                <h1><i class="bi bi-pencil" style="color: var(--accent-gold); margin-right: 12px;"></i>Modifier mon profil</h1>
            </div>
        </div>
        ...
        <div class="form-card">
            <form action="{{ route('users.updateProfile') }}" method="POST">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12">
                        ...
                        <a href="{{ route('users.profile') }}" class="btn-outline ms-3">Annuler</a>
                    </div>
                </div>
            </form>
            ...
            <h4 style="color: var(--accent-gold); margin-bottom: 20px;"><i class="bi bi-key"></i> Changer mon mot de passe</h4>
            <form action="{{ route('users.updateOwnPassword') }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row g-3">
                    <div class="col-12">
                        <label style="color: var(--text-light); font-weight: 600;">Mot de passe actuel *</label>
