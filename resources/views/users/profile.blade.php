...
@section('title', 'Mon Profil - TPI Sidi Bennour')
...
<div class="admin-wrapper">
    ...
    <main class="main-content">
        ...
        <div class="page-header" style="margin-bottom: 30px;">
            <h1 style="color: var(--text-light); font-weight: 800; font-size: 1.8rem;">
                <i class="bi bi-person-circle" style="color: var(--accent-gold);"></i> Mon Profil
            </h1>
        </div>
        ...
        <div class="row g-4">
            <div class="col-lg-4">
                <div class="detail-card text-center">
                    ...
                    <div style="margin-top: 20px;">
                        <a href="{{ route('users.editProfile') }}" class="btn-gold"><i class="bi bi-pencil"></i> Modifier mon profil</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-8">
                <div class="detail-card">
                    <h3><i class="bi bi-info-circle me-2"></i>Mes informations</h3>
                    ...
                    <div class="detail-row">
                        <span class="detail-label">Mon rôle</span>
